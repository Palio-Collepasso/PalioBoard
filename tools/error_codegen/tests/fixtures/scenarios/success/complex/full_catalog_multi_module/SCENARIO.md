# Success / Complex / full_catalog_multi_module
...
- `apps/api/src/palio/modules/results/errors_gen.py`
- `apps/api/src/palio/api/modules/results/errors/specs_gen.py`
- `apps/api/src/palio/api/modules/results/errors/mapping_gen.py`
...
- `runtime/problem_response.team.json`
