...
This document turns the product intent and the critical workflows into concise acceptance scenarios for thin-slice delivery.

Use it in two ways:
- treat each scenario as a business-facing acceptance target for one vertical slice
- use the scenarios marked **[Must-pass E2E]** as the v1 end-to-end shortlist; cover the others at the lowest test layer that still protects the risk
...
### 1. Complete a ranking game successfully **[Must-pass E2E]**
...
### 2. Block ranking-game completion when placements are invalid
...
### 3. Update public views after official result completion **[Must-pass E2E]**
...
### 4. Start a ranking game and initialize live draft correctly
...
### 5. Reject stale concurrent live-result writes **[Must-pass E2E]**
...
### 8. Complete a 1v1 tournament and update standings only at game completion **[Must-pass E2E]**
...
### 9. Edit a completed result and move to pending admin review **[Must-pass E2E]**
...
### 10. Mark a game under examination and exclude it from standings while keeping it visible
...
### 11. Apply Jolly correctly in Palio
...
### 13. Compute Prepalio aggregate ranking and feed the Palio standings
...
### 14. Keep Giocasport standings separate
...
### 15. Apply a manual standings adjustment with auditability
...
### 16. Block game configuration changes after official result data exists
