...
- `docs/api/error-contract.md` — generated human-readable overview of the committed wire contract and current catalog
...
2. Run `make errors` to validate the catalog and regenerate committed Python, TypeScript, and docs artifacts.
...
- `make errors` — validate the catalog and regenerate committed error artifacts
